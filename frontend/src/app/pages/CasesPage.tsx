    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        ...
        <p className="text-2xl text-gray-700 mt-4 mb-8 max-w-3xl">
          Learn from real examples to recognise scam patterns and protect yourself.
        </p>
        <section className="p-1 md:p-1.5 mb-4">
          <div className="flex flex-wrap items-end gap-2">
            <div>
              <p className="text-xs font-semibold text-gray-500 mb-0.5">Scam Type</p>
              <Select value={scamType} onValueChange={(v) => setFilter("scamType", v)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="suspicious-link">Suspicious Links</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-500 mb-0.5">Platform</p>
              <Select
                value={platform}
