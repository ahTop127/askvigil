    ...
    steps: [
      {
        ...
        description:
          "Do not reply or send more documents, payments, or personal info.",
      },
      {
        title: "Save Evidence",
        description:
      ...
      },
      {
        ...
        description:
          "Submit a report via https://www.mycert.org.my or call 1-300-88-2999. This helps authorities identify and take down malicious websites, phishing pages, and scam-related links.",
      },
    ],
  },
  phishing: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Change passwords immediately, especially email, banking, and any reused passwords and enable two-factor authentication (2FA).",
      },
      {
      ...
      },
      {
        title: "Contact your bank / NSRC",
        description:
          "If banking credentials, card details, or payment details were entered to any phishing websites:",
        bullets: [
          {
            label: "Single Bank Transaction",
            text: "Call your bank immediately to try to block or reverse the transaction.",
  ...
  "qr-scam": {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run a malware or antivirus scan to detect any harmful apps or software and remove it immediately.",
      },
      {
        title: "Save evidence",
        description:
          "Keep screenshots of chats, the QR code, payment receipts, phone numbers, and account numbers of the scammer.",
      },
      {
        title: "Contact your bank / NSRC",
        description:
          "If banking credentials, card details, or payment details were entered after scanning the QR or unauthorised bank transactions were made:",
        bullets: [
          {
            label: "Single Bank Transaction",
            text: "Call your bank immediately to try to block or reverse the transaction.",
  ...
  "suspicious-link": {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run a malware or antivirus to scan if the link downloaded anything to your device and remove it.",
      },
      {
        title: "Save evidence",
        description:
          "Keep screenshots of the message, the suspicious URL, sender details, website pages, and any transaction or login attempt related to the scam.",
      },
      {
        title: "Contact your bank / NSRC",
        description:
          "If money was lost or sensitive data was shared in the suspicious link:",
        bullets: [
          {
            label: "Single Bank Transaction",
            text: "Call your bank immediately to try to block or reverse the transaction.",
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-3">
                Contact the National Scam Response Centre (NSRC) at 997 or your
                bank's hotline immediately.
              </p>
            </div>
          </div>
        </div>
