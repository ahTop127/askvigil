...
> = {
  "job-scam": {
    ...
    icon: Briefcase,
    description:
      "Job scams happen when scammers pretend to offer attractive job opportunities in order to steal money, personal information, or bank details. They often target students, job seekers, and young adults by making the offer seem urgent, easy, and highly rewarding.",
    heroImage: job2,
    howItHappens: {
      ...
      exampleDescription:
        "A scammer contacts you on Telegram offering a 'data entry work from home' job earning RM3,000/month. They ask for a RM200 registration fee to 'secure your position'. After payment, they disappear.",
    },
    howToDefend: {
      ...
      tips: [
        {
          ...
          description:
            "Legitimate employers do not ask for fees before hiring.",
        },
        {
          icon: TrendingUp,
        ...
        },
        {
          ...
          description:
            "Sensitive information should only be shared with verified employers.",
        },
        {
          icon: Search,
          title: "Verify the company through official sources",
          description:
            "Check websites or trusted job platforms before proceeding.",
        },
        {
          icon: MessageCircle,
  ...
  phishing: {
    ...
    icon: Mail,
    description:
      "Phishing scams happen when scammers pretend to be trusted organisations, such as banks, delivery services, or government agencies, to trick users into giving away sensitive information. Their goal is often to steal passwords, banking details, or personal data.",
    heroImage: phishing2,
    howItHappens: {
      ...
      exampleDescription:
        "You receive an SMS claiming to be from your bank saying your account has been suspended. The message includes a link to 'verify your account'. The link leads to a fake banking website.",
    },
    howToDefend: {
      subtitle: "Here is what you can do to protect yourself.",
      tips: [
        ...
        },
        {
          ...
          description:
            "Fake websites are designed to steal your login details.",
        },
        {
          icon: FileWarning,
  ...
  "otp-scam": {
    ...
    icon: Smartphone,
    description:
      "OTP or SMS scams happen when scammers try to obtain one-time passwords or verification codes in order to access a victim’s bank account or online services. These scams often rely on impersonation, panic, and confusion.",
    heroImage: otp2,
    howItHappens: {
      ...
      exampleDescription:
        "Someone calls claiming to be from your bank, saying someone is trying to withdraw money. They ask you to share the OTP to 'stop the transaction'. In reality, they're using it to steal your money.",
    },
    howToDefend: {
      subtitle: "Here is what you can do to protect yourself.",
      tips: [
        {
          ...
          description:
            "Real banks will never ask for your OTP or security codes.",
        },
        {
          icon: Phone,
          title:
            "Don't respond to calls claiming to be from law enforcement agencies.",
          description:
            "Hang up and call the official number yourself to verify.",
        },
        {
          icon: Shield,
          title: "Never approve unauthorised transactions.",
          description:
            "Enable additional security features like 2FA on all accounts.",
        },
        {
          icon: AlertCircle,
          title: "Watch for unexpected OTP messages",
          description:
            "They may indicate someone is trying to access your account.",
        },
        {
          icon: Banknote,
  ...
  "qr-scam": {
    ...
    icon: QrCode,
    description:
      "QR code scams, also known as quishing, happen when scammers use fake or tampered QR codes to redirect victims to malicious websites, fake payment pages, or harmful downloads. Because QR codes are widely used for payments and information access, many users scan them without checking carefully.",
    heroImage: qr2,
    howItHappens: {
      ...
      exampleDescription:
        "You park and scan a QR code on a parking meter payment sticker. Instead of the official site, it takes you to a fake page. The scammers placed their own sticker over the real one.",
    },
    howToDefend: {
      subtitle: "Here is what you can do to protect yourself.",
      tips: [
        {
          ...
          description:
            "Check if QR codes look tampered with or have stickers over them.",
        },
        {
          icon: Store,
  ...
  "suspicious-link": {
    ...
    icon: LinkIcon,
    description:
      "Suspicious URL scams involve links that are designed to look legitimate but actually lead to fake or harmful websites. These websites may steal login credentials, banking information, or install malware.",
    heroImage: suslink2,
    howItHappens: {
      ...
      exampleDescription:
        "You receive an SMS claiming your package couldn't be delivered, with a link to 'reschedule'. After clicking and entering details, the scammers now have your personal and payment information.",
    },
    howToDefend: {
      subtitle: "Here is what you can do to protect yourself.",
      tips: [
        ...
        },
        {
          ...
          description:
            "Scammers often mimic real websites with slight changes.",
        },
        {
          icon: Keyboard,
          title: "Type official addresses directly.",
          description:
            "Go to websites by typing the URL yourself, not clicking links.",
        },
        {
          icon: EyeOff,
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-secondary/15 rounded-3xl p-12 text-center border-2 border-secondary/30 shadow-xl">
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
              Practice your scam detection skills or get immediate guidance if
