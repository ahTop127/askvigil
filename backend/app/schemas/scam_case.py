...
class ScamCaseResponse(BaseModel):
    ...
    content: str = Field(..., description="A complete description of the case, including the course of events and details")
    ...
    url_link: Optional[str] = Field(
        None,
        description="the url link of the scam cases."
    )
...
class ScamCaseFilterRequest(BaseModel):
    scam_type: Optional[ScamTypeEnum] = Field(default=None, description="Types of fraud")
