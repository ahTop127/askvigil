...
class QuizOption(models.Model):
    ...
    question = fields.ForeignKeyField(
        "models.QuizQuestion", related_name="options", on_delete=fields.CASCADE
    )
...
class QuizAttempt(models.Model):
    ...
    session = fields.ForeignKeyField(
        "models.UserSession", related_name="quiz_attempts", on_delete=fields.CASCADE
    )
    question = fields.ForeignKeyField(
        "models.QuizQuestion", related_name="attempts", on_delete=fields.CASCADE
    )
    selected_option = fields.ForeignKeyField(
        "models.QuizOption", related_name="selections", on_delete=fields.CASCADE
    )
