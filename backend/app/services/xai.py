...
def compute_loo_deltas(unpooled_tokens: np.ndarray, xgb_model, meta_vector: np.ndarray = None) -> np.ndarray:
...
def generate_text_explanation(raw_text: str, offset_mapping: np.ndarray, input_ids: np.ndarray, 
                              unpooled_tokens: np.ndarray, doc_embedding: np.ndarray, 
                              doc_text: str, xgb_deltas: np.ndarray) -> list:
